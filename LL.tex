...
The situation was even worse in the US, 
\textcolor{blue}{\bf as the number of canceled and delayed flights were twice as many as the figures recorded in Europe} ~(\citeauthor{flightstats}).
...
\citet{nikoleris2012queueing} used \ac{PSRA} to develop a single-server queuing model for trajectory-based aircraft operations that accounts explicitly for varying levels of imprecision in meeting prescribed times of arrival \textcolor{blue}{at either a point in the airspace or a runway’s threshold.}
